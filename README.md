local Configs_HUB = {
  Cor_Hub = Color3.fromRGB(30, 60, 150),
  Cor_Options = Color3.fromRGB(30, 60, 150),
  Cor_Stroke = Color3.fromRGB(135, 206, 250),
...
function MakeWindow(Configs)
  ...
  local function CreateClose()
    ...
    local Mensage = Create("TextLabel", CloseMenu, {
      ...
      Text = "Você tem certeza que deseja fechar o SH HUB? ",
